...
def main():
    ...
    while viewer.is_available() and not exit_signal:
        if zed.grab(runtime_params) == sl.ERROR_CODE.SUCCESS:
            ...
            cv2.putText(global_image, 'Persoane in cadru:' + str(len(objects.object_list)),
...
#cd C:\Users\rober\OneDrive\Desktop\zedstuff\ZED SDK\samples\object detection\custom detector\python\pytorch_yolov8
